...
var EventContainerWrapper =
  ...
  (function(_React$Component) {
    ...
    function EventContainerWrapper() {
      ...
      _this.handleMove = function(point, bounds) {
        if (!(0, _common.pointInColumn)(bounds, point)) {
          if ((0, _lodash.isFunction)(_this.props.handleNotPointInColumn)) {
            //处理鼠标/手势当前的点不在列中的情况
            return _this.props.handleNotPointInColumn(
        ...
        if ((0, _lodash.isFunction)(onMoving)) {
    ...
    _proto.handleResize = function handleResize(point, bounds) {
      ...
      if ((0, _lodash.isFunction)(onResizing)) {
    ...
    _proto.renderContent = function renderContent() {
      ...
      var isSomeResource = event.resourceId === resource //只有在同一个时间轴内的才会渲染Preview
        ...
        children: _react.default.createElement(
          ...
          event &&
            ...
            _react.default.createElement(_TimeGridEvent.default, {
              event: event,
              label: label, //修改点：为Preview Event新增标志位
              isPreview: true, //为previewEvent提供标志
              resizable: resizable,
              ...
              getters: getters, //修改点：components支持传入EventWrapper
...
EventContainerWrapper.propTypes =
  process.env.NODE_ENV !== 'production'
    ? {
        ...
        onMoving: _propTypes.default.func,
        onResizing: _propTypes.default.func,
        handleNotPointInColumn: _propTypes.default.func,
      }
    : {}
